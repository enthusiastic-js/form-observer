 ...
 * @returns {import("./types.d.ts").SvelteFormValidityObserver<M, R>}
 */
export default function createFormValidityObserver(types, options) {
  const observer = /** @type {import("./types.d.ts").SvelteFormValidityObserver<M, R>} */ (
  ...
  observer.configure = function configure(name, errorMessages) {
    const keys = /** @type {Array<keyof import("./types.d.ts").SvelteValidationErrors<M, any, R>>} */ (
