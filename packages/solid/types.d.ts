...
> {
   ...
   */
  configure<E extends ValidatableField>(name: string, errorMessages: SolidValidationErrors<M, E, R>): SolidFieldProps;
...
> extends Pick<ValidationErrors<M, E, R>, "badinput" | "validate"> {
  ...
  minlength?: SolidErrorDetails<M, JSX.InputHTMLAttributes<unknown>["minlength"], E, R>;
  min?: SolidErrorDetails<M, JSX.InputHTMLAttributes<unknown>["min"], E, R>;
  maxlength?: SolidErrorDetails<M, JSX.InputHTMLAttributes<unknown>["maxlength"], E, R>;
  max?: SolidErrorDetails<M, JSX.InputHTMLAttributes<unknown>["max"], E, R>;
  step?: SolidErrorDetails<M, JSX.InputHTMLAttributes<unknown>["step"], E, R>;
  type?: SolidErrorDetails<M, JSX.InputHTMLAttributes<unknown>["type"], E, R>;
  pattern?: SolidErrorDetails<M, JSX.InputHTMLAttributes<unknown>["pattern"], E, R>;
}

/** An augmentation of `ErrorDetails` for `Solid`. */
export type SolidErrorDetails<M, V, E extends ValidatableField = ValidatableField, R extends boolean = false> =
  | V
  | (R extends true
      ?
